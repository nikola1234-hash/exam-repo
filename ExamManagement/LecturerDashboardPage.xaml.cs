...
namespace ExamManagement.Views
{
    public sealed partial class LecturerDashboardPage : Page
    {
        ...
        private void CreateExamButton_Click (object sender, RoutedEventArgs args)
        {
            
        }
        private void EditExamButton_Click(object sender, RoutedEventArgs args)
        {
            
        } 
        private void DeleteExamButton_Click(object sender, RoutedEventArgs args)
        {
